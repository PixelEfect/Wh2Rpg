                        ...
                        .addOnSuccessListener { professionDoc ->
                            ...
                            button.setOnClickListener {
                                when (progressStage) {
                                    1 -> {
                                        val intent = Intent(
                                            this@UnfinishedCardsActivity,
                                            NewCardAttributesActivity::class.java
                                        )
                                    ...
                                    2 -> {
                                        val intent = Intent(
                                            this@UnfinishedCardsActivity,
                                            NewCardBackstoryActivity::class.java
                                        )
                                        intent.putExtra("CHARACTER_DOC_ID", documentId)  // Ustaw odpowiedni klucz
                                        intent.putExtra("CHARACTER_RACE", race)
                                        TransitionType.FADE
                                    ...
                                    3 -> {
                                        val intent = Intent(
                                            this@UnfinishedCardsActivity,
                                            NewCardProfessionsActivity::class.java
                                        )
                                        intent.putExtra("CHARACTER_DOC_ID", documentId)  // Ustaw odpowiedni klucz
                                        intent.putExtra("CHARACTER_RACE", race)
                                        TransitionType.FADE
                                    ...
                                    4 -> {
                                        val intent = Intent(
                                            this@UnfinishedCardsActivity,
                                            NewCardSkillsAndAbilitiesActivity::class.java
                                        )
                                        intent.putExtra("CHARACTER_DOC_ID", documentId)  // Ustaw odpowiedni klucz
                                        intent.putExtra("CHARACTER_RACE", race)
