...
import com.dd.rpgcardapp.databinding.ActivityCharacterStatsBinding
...
class StatsActivity : BaseActivity() {
    ...
    private lateinit var binding: ActivityCharacterStatsBinding

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCharacterStatsBinding.inflate(layoutInflater)
        ...
        binding.headerLayout.titleTextView.text = "${characterName ?: "Brak imienia"}"
    ...
    private fun fetchCharacterAttributes(characterDocId: String) {
        ...
        Tasks.whenAllSuccess<DocumentSnapshot>(baseDocTask, obtainedDocTask, progressionDocTask, skillsDocTask)
            .addOnSuccessListener { documents ->
                ...
                // Update UI with obtained values
                ...
                // Update UI with progression values
                ...
                setupStatUpgrades(obtainedA, obtainedInt, obtainedK, obtainedMag, obtainedOdp,
                    obtainedOgd, obtainedSW, obtainedSz, obtainedUS, obtainedWW, obtainedZr, obtainedZyw,
                    progressionA, progressionInt, progressionK, progressionMag, progressionOdp,
                    progressionOgd, progressionSW, progressionSz, progressionUS, progressionWW,
                    progressionZr, progressionZyw)
            }
    ...
    private fun setupStatUpgrades(
        obtainedA: Int, obtainedInt: Int, obtainedK: Int, obtainedMag: Int, obtainedOdp: Int,
        obtainedOgd: Int, obtainedSW: Int, obtainedSz: Int, obtainedUS: Int, obtainedWW: Int,
        obtainedZr: Int, obtainedZyw: Int, progressionA: Int, progressionInt: Int, progressionK: Int,
        progressionMag: Int, progressionOdp: Int, progressionOgd: Int, progressionSW: Int,
        progressionSz: Int, progressionUS: Int, progressionWW: Int, progressionZr: Int, progressionZyw: Int
    ) {
    ...
    private fun upgradeStat(statName: String, currentValue: Int, inputPD: Int, spendPD: Int, isMainStat: Boolean) {
        val pdToSpend = 100
        val bonus = if (isMainStat) 5 else 1
        val newObtainedVal = currentValue + bonus
        val newInputPD = inputPD - pdToSpend
        val newSpendPD = spendPD + pdToSpend
    ...
    // Navigation methods
    private fun navigateToNewProfession() {
        val intent = Intent(this, ProfessionActivity::class.java).apply {
