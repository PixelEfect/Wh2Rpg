...
class CardsListActivity : BaseActivity() {
    ...
    private fun loadCharacters() {
        ...
        db.collection(getString(R.string.collection_users)).document(userId)
            ...
            .orderBy(getString(R.string.field_last_active_at), Query.Direction.DESCENDING)
            .get()
                ...
                for (document in querySnapshot) {
                    ...
                    db.collection(getString(R.string.collection_users)).document(userId)
                        ...
                        .addOnSuccessListener { professionDoc ->
                            val professionName = professionDoc.getString(getString(R.string.field_profession_name)) ?: getString(
                                R.string.default_profession)
                            ...
                            val fullDisplay = "$displayText\n${getString(R.string.race_label)} $race\n${getString(
                                R.string.profession_label)} $professionName"
                            ...
                            val button = Button(this).apply {
                                ...
                                background = ContextCompat.getDrawable(this@CardsListActivity, R.drawable.buttony)
                            ...
                            button.setOnClickListener {
                                db.collection(getString(R.string.collection_users)).document(userId)
                                    .collection(getString(R.string.collection_characters)).document(documentId)
                                    .update(getString(R.string.field_last_active_at), Timestamp.now())
                                ...
                                val intent =
                                    Intent(this@CardsListActivity, StatsActivity::class.java)
