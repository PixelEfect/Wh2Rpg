...
import com.dd.rpgcardapp.views.create.NewCardAncestryActivity
import com.dd.rpgcardapp.R
import com.dd.rpgcardapp.base.BaseActivity
import com.dd.rpgcardapp.views.card.CardsListActivity
import com.dd.rpgcardapp.views.create.UnfinishedCardsActivity
...
class HomeActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.profileButton).setOnClickListener {
            ...
            startActivityWithTransition(Intent(this, ProfileActivity::class.java), TransitionType.FADE)
        }
        findViewById<Button>(R.id.myCardButton).setOnClickListener {
            // Start the ProfileActivity when the profile button is clicked
            startActivityWithTransition(Intent(this, CardsListActivity::class.java), TransitionType.FADE)
        }
        findViewById<Button>(R.id.unfinishedCardsButton).setOnClickListener {
            // Start the ProfileActivity when the profile button is clicked
            startActivityWithTransition(Intent(this, UnfinishedCardsActivity::class.java), TransitionType.FADE)
        }

        findViewById<ImageButton>(R.id.addCharacterButton).setOnClickListener {
            startActivityWithTransition(Intent(this, NewCardAncestryActivity::class.java), TransitionType.FADE)
        }
        findViewById<ImageButton>(R.id.testButton).setOnClickListener {
            startActivityWithTransition(Intent(this, ProfessionsConsistencyChecker::class.java), TransitionType.FADE)
        }
        findViewById<Button>(R.id.blessingBookButton).setOnClickListener {
            startActivityWithTransition(Intent(this, BlessingViewerActivity::class.java), TransitionType.FADE)
        }
