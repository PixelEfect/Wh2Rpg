...
object Professions {
    val professionMap: Map<String, Profession> = mapOf(
        ...
        BasicProfessions.Balsamista.name to BasicProfessions.Balsamista,
        BasicProfessions.Banita.name to BasicProfessions.Banita,
        BasicProfessions.BerserkerZNorski.name to BasicProfessions.BerserkerZNorski,
        BasicProfessions.BlednyRycerz.name to BasicProfessions.BlednyRycerz,
        BasicProfessions.BylySkazaniec.name to BasicProfessions.BylySkazaniec,
        BasicProfessions.Cenobita.name to BasicProfessions.Cenobita,
        BasicProfessions.Chlop.name to BasicProfessions.Chlop,
        BasicProfessions.CiuraObozowa.name to BasicProfessions.CiuraObozowa,
        BasicProfessions.Cyrkowiec.name to BasicProfessions.Cyrkowiec,
        BasicProfessions.Cyrulik.name to BasicProfessions.Cyrulik,
        BasicProfessions.Czekista.name to BasicProfessions.Czekista,
        BasicProfessions.CzeladnikRun.name to BasicProfessions.CzeladnikRun,
        BasicProfessions.Doker.name to BasicProfessions.Doker,
        BasicProfessions.Dylentant.name to BasicProfessions.Dylentant,
        BasicProfessions.Fanatyk.name to BasicProfessions.Fanatyk,
        BasicProfessions.Flisak.name to BasicProfessions.Flisak,
        BasicProfessions.Gazeciarz.name to BasicProfessions.Gazeciarz,
        BasicProfessions.Giermek.name to BasicProfessions.Giermek,
        BasicProfessions.Gladiator.name to BasicProfessions.Gladiator,
        BasicProfessions.Goniec.name to BasicProfessions.Goniec,
        BasicProfessions.Gornik.name to BasicProfessions.Gornik,
        BasicProfessions.Grabaz.name to BasicProfessions.Grabaz,
        BasicProfessions.Grabiezca.name to BasicProfessions.Grabiezca,
        BasicProfessions.Guslarz.name to BasicProfessions.Guslarz,
        BasicProfessions.HienaCmentarna.name to BasicProfessions.HienaCmentarna,
        BasicProfessions.Kadet.name to BasicProfessions.Kadet,
        BasicProfessions.Kanciarz.name to BasicProfessions.Kanciarz,
        BasicProfessions.Kartograf.name to BasicProfessions.Kartograf,
        BasicProfessions.Koczownik.name to BasicProfessions.Koczownik,
        BasicProfessions.Kominiarz.name to BasicProfessions.Kominiarz,
        BasicProfessions.Koniarz.name to BasicProfessions.Koniarz,
        BasicProfessions.Korsarz.name to BasicProfessions.Korsarz,
        BasicProfessions.KozakKislevski.name to BasicProfessions.KozakKislevski,
        BasicProfessions.Latarnik.name to BasicProfessions.Latarnik,
        BasicProfessions.Lesnik.name to BasicProfessions.Lesnik,
        BasicProfessions.Lowca.name to BasicProfessions.Lowca,
        BasicProfessions.LowcaNagrod.name to BasicProfessions.LowcaNagrod,
        BasicProfessions.Mieszczanin.name to BasicProfessions.Mieszczanin,
        BasicProfessions.Mytnik.name to BasicProfessions.Mytnik,
        BasicProfessions.Najemnik.name to BasicProfessions.Najemnik,
        BasicProfessions.Ochotnik.name to BasicProfessions.Ochotnik,
        BasicProfessions.Obszarnik.name to BasicProfessions.Obszarnik,
        BasicProfessions.Ochroniarz.name to BasicProfessions.Ochroniarz,
        BasicProfessions.Oprych.name to BasicProfessions.Oprych,
        BasicProfessions.Pacholek.name to BasicProfessions.Pacholek,
        BasicProfessions.PasterzZCarcassonne.name to BasicProfessions.PasterzZCarcassonne,
        BasicProfessions.Paz.name to BasicProfessions.Paz,
        BasicProfessions.Pielgrzym.name to BasicProfessions.Pielgrzym,
        BasicProfessions.PielgrzymGraala.name to BasicProfessions.PielgrzymGraala,
        BasicProfessions.PiratRzeczny.name to BasicProfessions.PiratRzeczny,
        BasicProfessions.Podzegacz.name to BasicProfessions.Podzegacz,
        BasicProfessions.Poganiacz.name to BasicProfessions.Poganiacz,
        BasicProfessions.PoganiaczMulow.name to BasicProfessions.PoganiaczMulow,
        BasicProfessions.Pogranicznik.name to BasicProfessions.Pogranicznik,
        BasicProfessions.Pokutnik.name to BasicProfessions.Pokutnik,
        BasicProfessions.PorywaczZwlok.name to BasicProfessions.PorywaczZwlok,
        BasicProfessions.PoskramiaczNiedzwiedzi.name to BasicProfessions.PoskramiaczNiedzwiedzi,
        BasicProfessions.Poslaniec.name to BasicProfessions.Poslaniec,
        BasicProfessions.Prawnik.name to BasicProfessions.Prawnik,
        BasicProfessions.Przemytnik.name to BasicProfessions.Przemytnik,
        BasicProfessions.Przepatrywacz.name to BasicProfessions.Przepatrywacz,
        BasicProfessions.Przewoznik.name to BasicProfessions.Przewoznik,
        BasicProfessions.Pustelnik.name to BasicProfessions.Pustelnik,
        BasicProfessions.RogatyLowca.name to BasicProfessions.RogatyLowca,
        BasicProfessions.Rolnik.name to BasicProfessions.Rolnik,
        BasicProfessions.Rozjemca.name to BasicProfessions.Rozjemca,
        BasicProfessions.Rybak.name to BasicProfessions.Rybak,
        BasicProfessions.RzecznikRodu.name to BasicProfessions.RzecznikRodu,
        BasicProfessions.Rzemieslnik.name to BasicProfessions.Rzemieslnik,
        BasicProfessions.Rzezimieszek.name to BasicProfessions.Rzezimieszek,
        BasicProfessions.Skald.name to BasicProfessions.Skald,
        BasicProfessions.Skarbnik.name to BasicProfessions.Skarbnik,
        BasicProfessions.Skryba.name to BasicProfessions.Skryba,
        BasicProfessions.Sluga.name to BasicProfessions.Sluga,
        BasicProfessions.Straznik.name to BasicProfessions.Straznik,
        BasicProfessions.StraznikDrog.name to BasicProfessions.StraznikDrog,
        BasicProfessions.StraznikKanalow.name to BasicProfessions.StraznikKanalow,
        BasicProfessions.StraznikPol.name to BasicProfessions.StraznikPol,
        BasicProfessions.StraznikRzeczny.name to BasicProfessions.StraznikRzeczny,
        BasicProfessions.StraznikSwiatynny.name to BasicProfessions.StraznikSwiatynny,
        BasicProfessions.StraznikTuneli.name to BasicProfessions.StraznikTuneli,
        BasicProfessions.StraznikWiezienny.name to BasicProfessions.StraznikWiezienny,
        BasicProfessions.Strielec.name to BasicProfessions.Strielec,
        BasicProfessions.StrzyganskiMistyk.name to BasicProfessions.StrzyganskiMistyk,
        BasicProfessions.Szczurolap.name to BasicProfessions.Szczurolap,
        BasicProfessions.SzermierzEstalijski.name to BasicProfessions.SzermierzEstalijski,
        BasicProfessions.Szlachcic.name to BasicProfessions.Szlachcic,
        BasicProfessions.Szperacz.name to BasicProfessions.Szperacz,
        BasicProfessions.Szuler.name to BasicProfessions.Szuler,
        BasicProfessions.Smieciarz.name to BasicProfessions.Smieciarz,
        BasicProfessions.Tarczownik.name to BasicProfessions.Tarczownik,
        BasicProfessions.UczenCzarodzieja.name to BasicProfessions.UczenCzarodzieja,
        BasicProfessions.UczennicaCzarownicy.name to BasicProfessions.UczennicaCzarownicy,
        BasicProfessions.UczenZielarza.name to BasicProfessions.UczenZielarza,
        BasicProfessions.Weglarz.name to BasicProfessions.Weglarz,
        BasicProfessions.Wielorybnik.name to BasicProfessions.Wielorybnik,
        BasicProfessions.Wloczykij.name to BasicProfessions.Wloczykij,
        BasicProfessions.Woj.name to BasicProfessions.Woj,
        BasicProfessions.WojownikKlanowy.name to BasicProfessions.WojownikKlanowy,
        BasicProfessions.Woznica.name to BasicProfessions.Woznica,
        BasicProfessions.Wrozbita.name to BasicProfessions.Wrozbita,
        BasicProfessions.Zabiarka.name to BasicProfessions.Zabiarka,
        BasicProfessions.ZabojcaTrolli.name to BasicProfessions.ZabojcaTrolli,
        BasicProfessions.Zakapturzony.name to BasicProfessions.Zakapturzony,
        BasicProfessions.Zarzadca.name to BasicProfessions.Zarzadca,
        BasicProfessions.ZbieraczLajna.name to BasicProfessions.ZbieraczLajna,
        BasicProfessions.Zlodziej.name to BasicProfessions.Zlodziej,
        BasicProfessions.Zak.name to BasicProfessions.Zak,
        BasicProfessions.Zeglarz.name to BasicProfessions.Zeglarz,
        BasicProfessions.Znachorka.name to BasicProfessions.Znachorka,
        BasicProfessions.Zolnierz.name to BasicProfessions.Zolnierz,
        ...
        AdvancedProfessions.Arcymistrz.name to AdvancedProfessions.Arcymistrz,
        AdvancedProfessions.ArcymistrzRun.name to AdvancedProfessions.ArcymistrzRun,
        AdvancedProfessions.ArcymistrzZielarstwa.name to AdvancedProfessions.ArcymistrzZielarstwa,
        AdvancedProfessions.Artylerzysta.name to AdvancedProfessions.Artylerzysta,
        AdvancedProfessions.Arystokrata.name to AdvancedProfessions.Arystokrata,
        AdvancedProfessions.Astrolog.name to AdvancedProfessions.Astrolog,
        AdvancedProfessions.Ataman.name to AdvancedProfessions.Ataman,
        AdvancedProfessions.Bard.name to AdvancedProfessions.Bard,
        AdvancedProfessions.Bezimienny.name to AdvancedProfessions.Bezimienny,
        AdvancedProfessions.BiczBozy.name to AdvancedProfessions.BiczBozy,
        AdvancedProfessions.Biczownik.name to AdvancedProfessions.Biczownik,
        AdvancedProfessions.Bosman.name to AdvancedProfessions.Bosman,
        AdvancedProfessions.Brygadzista.name to AdvancedProfessions.Brygadzista,
        AdvancedProfessions.Budowniczy.name to AdvancedProfessions.Budowniczy,
        AdvancedProfessions.Ceremoniarz.name to AdvancedProfessions.Ceremoniarz,
        AdvancedProfessions.Czarownik.name to AdvancedProfessions.Czarownik,
        AdvancedProfessions.Czarnoksieznik.name to AdvancedProfessions.Czarnoksieznik,
        AdvancedProfessions.CzarnyStraznik.name to AdvancedProfessions.CzarnyStraznik,
        AdvancedProfessions.Demagog.name to AdvancedProfessions.Demagog,
        AdvancedProfessions.Dworak.name to AdvancedProfessions.Dworak,
        AdvancedProfessions.Dworzanin.name to AdvancedProfessions.Dworzanin,
        AdvancedProfessions.Egzorcysta.name to AdvancedProfessions.Egzorcysta,
        AdvancedProfessions.Falszerz.name to AdvancedProfessions.Falszerz,
        AdvancedProfessions.Fechtmistrz.name to AdvancedProfessions.Fechtmistrz,
        AdvancedProfessions.HandlarzNiewolnikami.name to AdvancedProfessions.HandlarzNiewolnikami,
        AdvancedProfessions.Herold.name to AdvancedProfessions.Herold,
        AdvancedProfessions.HersztBanitow.name to AdvancedProfessions.HersztBanitow,
        AdvancedProfessions.Husarz.name to AdvancedProfessions.Husarz,
        AdvancedProfessions.Inzynier.name to AdvancedProfessions.Inzynier,
        AdvancedProfessions.Kapitan.name to AdvancedProfessions.Kapitan,
        AdvancedProfessions.Kaplan.name to AdvancedProfessions.Kaplan,
        AdvancedProfessions.KaplanSwiecki.name to AdvancedProfessions.KaplanSwiecki,
        AdvancedProfessions.KaplanWojownik.name to AdvancedProfessions.KaplanWojownik,
        AdvancedProfessions.Karczmarz.name to AdvancedProfessions.Karczmarz,
        AdvancedProfessions.Katecheta.name to AdvancedProfessions.Katecheta,
        AdvancedProfessions.Koniuszy.name to AdvancedProfessions.Koniuszy,
        AdvancedProfessions.KonnyLucznik.name to AdvancedProfessions.KonnyLucznik,
        AdvancedProfessions.KowalRun.name to AdvancedProfessions.KowalRun,
        AdvancedProfessions.Krzyzowiec.name to AdvancedProfessions.Krzyzowiec,
        AdvancedProfessions.KsiazeZlodziei.name to AdvancedProfessions.KsiazeZlodziei,
        AdvancedProfessions.Kupiec.name to AdvancedProfessions.Kupiec,
        AdvancedProfessions.Lajdak.name to AdvancedProfessions.Lajdak,
        AdvancedProfessions.LesnyDuch.name to AdvancedProfessions.LesnyDuch,
        AdvancedProfessions.LodowaCzarownica.name to AdvancedProfessions.LodowaCzarownica,
        AdvancedProfessions.LodowaPanna.name to AdvancedProfessions.LodowaPanna,
        AdvancedProfessions.LowcaCzarownic.name to AdvancedProfessions.LowcaCzarownic,
        AdvancedProfessions.LowcaWampirow.name to AdvancedProfessions.LowcaWampirow,
        AdvancedProfessions.MagisterRewizor.name to AdvancedProfessions.MagisterRewizor,
        AdvancedProfessions.Majordomus.name to AdvancedProfessions.Majordomus,
        AdvancedProfessions.Medyk.name to AdvancedProfessions.Medyk,
        AdvancedProfessions.MistrzCieni.name to AdvancedProfessions.MistrzCieni,
        AdvancedProfessions.MistrzGildii.name to AdvancedProfessions.MistrzGildii,
        AdvancedProfessions.MistrzMagii.name to AdvancedProfessions.MistrzMagii,
        AdvancedProfessions.MistrzRun.name to AdvancedProfessions.MistrzRun,
        AdvancedProfessions.MistrzRzemiosla.name to AdvancedProfessions.MistrzRzemiosla,
        AdvancedProfessions.MistrzZakonny.name to AdvancedProfessions.MistrzZakonny,
        AdvancedProfessions.MistrzZielarstwa.name to AdvancedProfessions.MistrzZielarstwa,
        AdvancedProfessions.Mistyk.name to AdvancedProfessions.Mistyk,
        AdvancedProfessions.Mnich.name to AdvancedProfessions.Mnich,
        AdvancedProfessions.Nawigator.name to AdvancedProfessions.Nawigator,
        AdvancedProfessions.Opat.name to AdvancedProfessions.Opat,
        AdvancedProfessions.Odkrywca.name to AdvancedProfessions.Odkrywca,
        AdvancedProfessions.Oficer.name to AdvancedProfessions.Oficer,
        AdvancedProfessions.Oprawca.name to AdvancedProfessions.Oprawca,
        AdvancedProfessions.Pamflecista.name to AdvancedProfessions.Pamflecista,
        AdvancedProfessions.Paser.name to AdvancedProfessions.Paser,
        AdvancedProfessions.PielgrzymBitewny.name to AdvancedProfessions.PielgrzymBitewny,
        AdvancedProfessions.Prawiedzma.name to AdvancedProfessions.Prawiedzma,
        AdvancedProfessions.Prelat.name to AdvancedProfessions.Prelat,
        AdvancedProfessions.Psalterzysta.name to AdvancedProfessions.Psalterzysta,
        AdvancedProfessions.Rajtar.name to AdvancedProfessions.Rajtar,
        AdvancedProfessions.Reketer.name to AdvancedProfessions.Reketer,
        AdvancedProfessions.Rozbojnik.name to AdvancedProfessions.Rozbojnik,
        AdvancedProfessions.Rycerz.name to AdvancedProfessions.Rycerz,
        AdvancedProfessions.RycerzGraala.name to AdvancedProfessions.RycerzGraala,
        AdvancedProfessions.RycerzKrolestwa.name to AdvancedProfessions.RycerzKrolestwa,
        AdvancedProfessions.RycerzKruka.name to AdvancedProfessions.RycerzKruka,
        AdvancedProfessions.RycerzPantery.name to AdvancedProfessions.RycerzPantery,
        AdvancedProfessions.RycerzPlonacegoSlonca.name to AdvancedProfessions.RycerzPlonacegoSlonca,
        AdvancedProfessions.RycerzProby.name to AdvancedProfessions.RycerzProby,
        AdvancedProfessions.RycerzZakonuZielonejChoragwi.name to AdvancedProfessions.RycerzZakonuZielonejChoragwi,
        AdvancedProfessions.Sierzant.name to AdvancedProfessions.Sierzant,
        AdvancedProfessions.Skrytobojca.name to AdvancedProfessions.Skrytobojca,
        AdvancedProfessions.StarszyWioskowy.name to AdvancedProfessions.StarszyWioskowy,
        AdvancedProfessions.StrozPrawa.name to AdvancedProfessions.StrozPrawa,
        AdvancedProfessions.Strzelec.name to AdvancedProfessions.Strzelec,
        AdvancedProfessions.Szampierz.name to AdvancedProfessions.Szampierz,
        AdvancedProfessions.Szarlatan.name to AdvancedProfessions.Szarlatan,
        AdvancedProfessions.Szpieg.name to AdvancedProfessions.Szpieg,
        AdvancedProfessions.SledczyVereny.name to AdvancedProfessions.SledczyVereny,
        AdvancedProfessions.TreserZwierzat.name to AdvancedProfessions.TreserZwierzat,
        AdvancedProfessions.Tropiciel.name to AdvancedProfessions.Tropiciel,
        AdvancedProfessions.Uczony.name to AdvancedProfessions.Uczony,
        AdvancedProfessions.Urzednik.name to AdvancedProfessions.Urzednik,
        AdvancedProfessions.Vitki.name to AdvancedProfessions.Vitki,
        AdvancedProfessions.Weteran.name to AdvancedProfessions.Weteran,
        AdvancedProfessions.WedrownyCzarodziej.name to AdvancedProfessions.WedrownyCzarodziej,
        AdvancedProfessions.Wiedzma.name to AdvancedProfessions.Wiedzma,
        AdvancedProfessions.Wlamywacz.name to AdvancedProfessions.Wlamywacz,
        AdvancedProfessions.Wodz.name to AdvancedProfessions.Wodz,
        AdvancedProfessions.WtajemniczonyKultuKhorna.name to AdvancedProfessions.WtajemniczonyKultuKhorna,
        AdvancedProfessions.WtajemniczonyKultuNurgla.name to AdvancedProfessions.WtajemniczonyKultuNurgla,
        AdvancedProfessions.WtajemniczonyKultuSlaanesha.name to AdvancedProfessions.WtajemniczonyKultuSlaanesha,
        AdvancedProfessions.WtajemniczonyKultuTzeentcha.name to AdvancedProfessions.WtajemniczonyKultuTzeentcha,
        AdvancedProfessions.WybraniecBozy.name to AdvancedProfessions.WybraniecBozy,
        AdvancedProfessions.ZabojcaDemonow.name to AdvancedProfessions.ZabojcaDemonow,
        AdvancedProfessions.ZabojcaNieumarlych.name to AdvancedProfessions.ZabojcaNieumarlych,
        AdvancedProfessions.ZabojcaOlbrzymow.name to AdvancedProfessions.ZabojcaOlbrzymow,
        AdvancedProfessions.ZakapturzonyBrat.name to AdvancedProfessions.ZakapturzonyBrat,
        AdvancedProfessions.Zakonnik.name to AdvancedProfessions.Zakonnik,
        AdvancedProfessions.Zbrojny.name to AdvancedProfessions.Zbrojny,
        AdvancedProfessions.Zwadzca.name to AdvancedProfessions.Zwadzca,
        AdvancedProfessions.Zwiadowca.name to AdvancedProfessions.Zwiadowca,
        SkavenProfessions.Czarnoszczur.name to SkavenProfessions.Czarnoszczur,
        SkavenProfessions.CzcicielZarazy.name to SkavenProfessions.CzcicielZarazy,
        SkavenProfessions.Harcownik.name to SkavenProfessions.Harcownik,
        SkavenProfessions.Klanbrat.name to SkavenProfessions.Klanbrat,
        SkavenProfessions.Niewolnik.name to SkavenProfessions.Niewolnik,
        SkavenProfessions.PoganiaczSkavenski.name to SkavenProfessions.PoganiaczSkavenski,
        SkavenProfessions.PoslaniecNocy.name to SkavenProfessions.PoslaniecNocy,
        SkavenProfessions.UczenSzaregoProroka.name to SkavenProfessions.UczenSzaregoProroka,
        SkavenProfessions.DiakonZarazy.name to SkavenProfessions.DiakonZarazy,
        SkavenProfessions.HersztKlanu.name to SkavenProfessions.HersztKlanu,
        SkavenProfessions.InzynierSpaczenia.name to SkavenProfessions.InzynierSpaczenia,
        SkavenProfessions.Kadzielnik.name to SkavenProfessions.Kadzielnik,
        SkavenProfessions.KaplanZarazy.name to SkavenProfessions.KaplanZarazy,
        SkavenProfessions.MistrzCialoksztaltowania.name to SkavenProfessions.MistrzCialoksztaltowania,
        SkavenProfessions.MistrzMutator.name to SkavenProfessions.MistrzMutator,
        SkavenProfessions.MistrzSkrytobojca.name to SkavenProfessions.MistrzSkrytobojca,
        SkavenProfessions.Nadprorok.name to SkavenProfessions.Nadprorok,
        SkavenProfessions.Rynsztokowiec.name to SkavenProfessions.Rynsztokowiec,
        SkavenProfessions.SkavenskiZaklinacz.name to SkavenProfessions.SkavenskiZaklinacz,
        SkavenProfessions.SzaryProrok.name to SkavenProfessions.SzaryProrok,
        SkavenProfessions.Szponowlad.name to SkavenProfessions.Szponowlad,
        SkavenProfessions.Szturmoszczur.name to SkavenProfessions.Szturmoszczur,
        TribeProfessions.UczenSzamana.name to TribeProfessions.UczenSzamana,
        TribeProfessions.Szaman.name to TribeProfessions.Szaman,
        TribeProfessions.WielkiSzaman.name to TribeProfessions.WielkiSzaman,
        TribeProfessions.Knuj.name to TribeProfessions.Knuj,
        TribeProfessions.Silacz.name to TribeProfessions.Silacz,
        TribeProfessions.WodzPlemienny.name to TribeProfessions.WodzPlemienny,
        AnimalProfessions.TresowanyNiedzwiedz.name to AnimalProfessions.TresowanyNiedzwiedz,
        BeastmenProfessions.Bestigor.name to BeastmenProfessions.Bestigor,
        BeastmenProfessions.WodzZwierzoludzi.name to BeastmenProfessions.WodzZwierzoludzi,
        BeastmenProfessions.SzamanRykowcowK.name to BeastmenProfessions.SzamanRykowcowK,
        BeastmenProfessions.SzamanRykowcowNST.name to BeastmenProfessions.SzamanRykowcowNST,
        BeastmenProfessions.WielkiSzamanRykowcowK.name to BeastmenProfessions.WielkiSzamanRykowcowK,
        BeastmenProfessions.WielkiSzamanRykowcowNST.name to BeastmenProfessions.WielkiSzamanRykowcowNST,
        )
}
