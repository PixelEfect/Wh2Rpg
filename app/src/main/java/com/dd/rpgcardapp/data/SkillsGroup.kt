...
object SkillsGroupSimplifier {
    private val knownGroups = mapOf(
        ...
        KnightBlessing.All.map { it.name }.toSet() to "Błogosławieństwo (dowolne)",
