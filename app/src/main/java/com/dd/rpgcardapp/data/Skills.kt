...
object MagicSkills {
    ...
    val magiaKaplanskaTaal = Skill("Magia kapłańska: Taal", "Dostep do czarów kapłańskich Taala")
    val magiaKaplanskaRhyia = Skill("Magia kapłańska: Rhyia", "Dostep do czarów kapłańskich Rhyi")
